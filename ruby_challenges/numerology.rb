puts "What is our birthdate? Put it in the form [MMDDYYYY]"
birthdate = gets.chomp
sum = birthdate[0].to_i + birthdate[1].to_i + birthdate[2].to_i + birthdate[3].to_i + birthdate[4].to_i + birthdate[5].to_i + birthdate[6].to_i + birthdate[7].to_i
